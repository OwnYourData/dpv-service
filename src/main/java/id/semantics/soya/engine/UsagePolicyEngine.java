...
public class UsagePolicyEngine {
    ...
    public UsagePolicyEngine() {
        dataSubjectPolicy = ResourceFactory.createResource(DPVO_SOYA.NS + Service.DATA_SUBJECT);
        dataControllerPolicy = ResourceFactory.createResource(DPVO_SOYA.NS + Service.DATA_CONTROLLER);
    }
