...
public enum ConsentHandle {
    ...
    ConsentHandle() {
        if (dpvModel.isEmpty()) {
            InputStream dpvo_lite = ConsentHandle.class.getClassLoader().getResourceAsStream("dpv/dpvo-05-lite.ttl");
...
//            }
    ...
    public String consentJsonToString(JSONObject dpvInput) throws UnregisteredTermException {
        ...
        model.add(getPolicy(DPVO_SOYA.NS+DATA_SUBJECT, userConsent));
        model.add(getPolicy(DPVO_SOYA.NS+DATA_CONTROLLER, controllerHandling));
    ...
    private Model getConsent(Resource consent, String data, String processing, String purpose, String recipient, String location, String expiry)
        ...
        consentModel.setNsPrefix("dpv", DPVO.NS);
